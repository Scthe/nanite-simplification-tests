...
import { LoadedObject } from '../scene/load/loadScene.ts';
...
} from '../scene/objLoader.ts';
import { assertValidNaniteObject } from '../scene/assertValidNaniteObject.ts';
import { ObjectLoaderParams, createImpostors } from '../loadObject.ts';
